...
def windowTrig(action):
    ...
    elif check("حفظ جدول الحروف كـ .ate"): saveATE(save_file('ate', TableEditorWindow), Table)
    elif check("حفظ جدول الحروف كـ .csv"): saveCSV(save_file('csv', TableEditorWindow), Table)
