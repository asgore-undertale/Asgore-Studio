...
def drawFontTable(aftPath, chars, cellWidth, cellHeight, imgSize, fontPath, fontSize, rightOffset, fontmode, savepath):
    ...
    for char in chars:
        ...
        if fontPath.endswith('.ttf'):
            x += (cellWidth - font.getsize(char)[0]) * rightOffset
